...
const sharedEnv = `AUTH_SECRET=playwright-test-secret AUTH_TRUST_HOST=true NEXT_PUBLIC_APP_NAME='The Unique Hope' NEXT_PUBLIC_APP_URL='http://127.0.0.1:3100' NEXT_PUBLIC_DEFAULT_LOCALE='en' RATE_LIMIT_HASH_KEY='playwright-rate-limit-hash-key-012345' BLOB_READ_WRITE_TOKEN='test-token' SEED_ADMIN_EMAIL='admin@theuniquehope.org' SEED_ADMIN_NAME='The Unique Hope Admin' SEED_ADMIN_PASSWORD='playwright-admin-secret-2026' SEED_ADMIN_USERNAME='admin' SEED_DEMO_DATA='true'`;
